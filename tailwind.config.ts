		...
		extend: {
			...
			keyframes: {
				...
				'float-1': {
					...
					'50%': { 
						transform: 'translate(-100px, -160px) rotate(-10deg)',
						opacity: '0.8'
					},
					'75%': { 
				...
				'float-2': {
					...
					'33%': { 
						transform: 'translate(-180px, -120px) rotate(-20deg)',
						opacity: '0.9'
					},
					'66%': { 
				...
				'float-3': {
					...
					'20%': { 
						transform: 'translate(120px, -100px) rotate(12deg)',
						opacity: '0.8'
					},
					'60%': { 
						transform: 'translate(-160px, -180px) rotate(-25deg)',
						opacity: '1'
					},
					'80%': { 
